...
DEFAULT_ACTIVITIES = {
    ...
    "Drama Club": {
        "description": "Rehearse scenes, learn acting techniques, and stage performances",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["hannah@mergington.edu", "kevin@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Explore drawing, painting, and mixed media art projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["mia@mergington.edu", "eli@mergington.edu"]
    },
    "Robotics Club": {
...
def create_app(activities_db=None):
    """Factory function to create FastAPI app with optional activities database"""
    if activities_db is None:
        activities_db = DEFAULT_ACTIVITIES.copy()
...
# Create default app instance for running the server
app = create_app()
